...
const ConfirmWalletModal: React.FC<IConfirmWalletModal> = ({ message, onClose, details }) => {
  ...
  return (
    <BaseModal onClose={onClose}>
      ...
      <div className="relative text-center max-w-[500px] md:w-[500px] flex flex-col gap-5 items-center justify-center bg-secondary rounded-xl p-8">
        ...
        {details && <p className="mt-0 text-OPlightgray">{details}</p>} {/* Render additional details if provided */}
      </div>
    </BaseModal>
  );
};
