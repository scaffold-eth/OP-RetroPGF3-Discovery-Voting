    ...
    <div className="w-full pb-6">
      ...
      <div className="relative flex items-center">
        ...
        <Image
          width={28}
          height={28}
          className="rounded  border-customWhite border-2  outline-white outline-2 z-1 ml-[-5px]"
          src="/assets/Logo.png"
          alt="Avatar"
        />
        <Image
          width={28}
          height={28}
          className="rounded  border-customWhite border-2  outline-white outline-2 z-2 ml-[-8px]"
        ...
        <Image
          width={28}
          height={28}
          className="rounded  border-customWhite border-2  outline-white outline-2 z-3 ml-[-10px]"
