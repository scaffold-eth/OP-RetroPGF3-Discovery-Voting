      ...
      {display === "grids" ? (
        <div className="rounded-[1.5rem] animate-pulse p-4 bg-base-100 ">
          <div className="relative overflow-hidden bg-cover bg-no-repeat">
            ...
            <div className="mt-[-22px] ml-[20px] p-1 bg-base-100 overflow-hidden w-14 h-14 rounded inline-block">
        ...
        <div className="flex  animate-pulse border rounded-[1.5rem] border-gray-300  p-4 ">
          <div className=" p-1   bg-base-100 overflow-hidden w-14 h-14 rounded inline-block">
            <div className="bg-gray-300  w-full h-full"></div>
          </div>
